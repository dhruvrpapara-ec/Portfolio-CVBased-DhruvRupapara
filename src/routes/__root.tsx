...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Dhruv Rupapara — Portfolio" },
      { name: "description", content: "Portfolio of Dhruv Rupapara — Electronics & Communication Engineering undergraduate, leader at IEEE & NSS, CHARUSAT." },
      { name: "author", content: "Dhruv Rupapara" },
